...
export default class AtlasProtocol {
     ...
     */
    constructor(account: AtlasWalletAccountLike, config?: AtlasProtocolConfig);
    /** @private */
    private _account;
    /** @private */
    private _config;
     ...
     * @throws {import('./errors.js').AtlasNotImplementedError} Always, on the abstract base.
     */
    prepare(route: Route): Promise<RoutePreparation>;
    /**
     ...
     * @throws {import('./errors.js').AtlasNotImplementedError} Always, on the abstract base.
     */
    getStatus(providerRouteId: ProviderRouteId): Promise<RouteExecution>;
}
export type QuoteInput = import("./types.js").QuoteInput;
export type Quote = import("./types.js").Quote;
export type Route = import("./types.js").Route;
export type RoutePreparation = import("./types.js").RoutePreparation;
export type RouteExecution = import("./types.js").RouteExecution;
export type ProviderRouteId = import("./types.js").ProviderRouteId;
export type AtlasWalletAccountLike = import("./types.js").AtlasWalletAccountLike;
export type AtlasProtocolConfig = import("./config.js").AtlasProtocolConfig;
